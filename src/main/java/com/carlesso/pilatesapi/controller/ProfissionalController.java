...
public class ProfissionalController {
    ...
    private static final MediaType APPLICATION_XLSX =
    ...
    @Operation(
            ...
            description =
                    "Registra um novo profissional no sistema. Retorna 201 com o header Location apontando para o recurso criado.")
    @ApiResponses({
    ...
    public ResponseEntity<ProfissionalResponseDTO> cadastrar(
            @RequestBody @Valid ProfissionalRequestDTO dto, UriComponentsBuilder uriBuilder) {
    ...
    @Operation(
            summary = "Listar e filtrar profissionais",
            description =
                    "Retorna uma página de profissionais filtrando por nome, e-mail, tipo de contrato, percentual por aula e status ativo/inativo. Por padrão retorna profissionais ativos. Suporta paginação e ordenação via query params.")
    ...
    public ResponseEntity<Page<ProfissionalResponseDTO>> listar(
            ...
            @Parameter(description = "Filtro por tipo de contrato") @RequestParam(required = false)
                    TipoContrato tipoContrato,
            @Parameter(description = "Filtro por percentual de pagamento por aula") @RequestParam(required = false)
                    BigDecimal percentualPagamentoAula,
            @Parameter(description = "Filtra por status. Quando omitido, retorna apenas ativos.")
    ...
    @Operation(
            ...
            description = "Retorna os dados completos de um profissional pelo seu identificador único.")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Atualiza os dados de um profissional. Apenas os campos enviados serão alterados.")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Reativa um profissional previamente inativado, definindo ativo = true.")
    @ApiResponses({
    ...
    @Operation(
            ...
            description =
                    "Realiza soft delete do profissional, marcando-o como inativo. O registro não é removido do banco.")
    @ApiResponses({
    ...
    @Operation(
            summary = "Gerar relatório de pagamento do profissional",
            description =
                    "Retorna o relatório financeiro estruturado em sub-objetos (profissional, periodo, resumo, pagamentos, aulas), pronto para consumo no Angular.")
    @ApiResponses({
    ...
    @Operation(
            summary = "Exportar relatório de pagamento em PDF",
            description =
                    "Gera o relatório de pagamento do profissional em PDF para download. Usa o mesmo cálculo do endpoint JSON.")
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
    ...
    @Operation(
            summary = "Exportar relatório de pagamento em Excel",
            description =
                    "Gera o relatório de pagamento do profissional em XLSX para download, com abas para resumo, pagamentos e aulas.")
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
    ...
    @GetMapping(
            value = "/{id}/relatorio-pagamento/xlsx",
